...
{
  public Task<IEnumerable<PostDto>> GetPreviousPostsFromPostId(int lastPostId);
  ...
  public Task<IEnumerable<PostDto>> GetPriviousPostsFromPostIdForUser(int lastId, int userId);
